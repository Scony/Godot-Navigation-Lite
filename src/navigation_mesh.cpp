...
void DetourNavigationMesh::_register_methods()
{
  ...
  register_property<DetourNavigationMesh, int>(
      "collision_mask",
      &DetourNavigationMesh::set_collision_mask,
      &DetourNavigationMesh::get_collision_mask,
      1,
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_DEFAULT,
      GODOT_PROPERTY_HINT_LAYERS_3D_PHYSICS);
  register_property<DetourNavigationMesh, String>(
      "group_name",
      &DetourNavigationMesh::set_group_name,
      &DetourNavigationMesh::get_group_name,
      "",
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_DEFAULT,
  ...
  register_property<DetourNavigationMesh, Color>(
      "debug_mesh_color",
      &DetourNavigationMesh::set_debug_mesh_color,
      &DetourNavigationMesh::get_debug_mesh_color,
      Color(0.1f, 1.0f, 0.7f, 0.4f));

  register_property<DetourNavigationMesh, Array>(
      "input_meshes_storage",
      &DetourNavigationMesh::set_input_meshes_storage,
      &DetourNavigationMesh::get_input_meshes_storage,
      Array(),
      GODOT_METHOD_RPC_MODE_DISABLED,
  ...
  register_property<DetourNavigationMesh, Array>(
      ...
      &DetourNavigationMesh::set_input_transforms_storage,
      &DetourNavigationMesh::get_input_transforms_storage,
      Array(),
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_STORAGE,
      GODOT_PROPERTY_HINT_NONE);
  register_property<DetourNavigationMesh, Array>(
      "input_aabbs_storage",
      &DetourNavigationMesh::set_input_aabbs_storage,
      &DetourNavigationMesh::get_input_aabbs_storage,
      Array(),
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_STORAGE,
      GODOT_PROPERTY_HINT_NONE);
  register_property<DetourNavigationMesh, Array>(
      ...
      &DetourNavigationMesh::set_collision_ids_storage,
      &DetourNavigationMesh::get_collision_ids_storage,
      Array(),
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_STORAGE,
      GODOT_PROPERTY_HINT_NONE);
  register_property<DetourNavigationMesh, String>(
      "uuid",
      &DetourNavigationMesh::set_uuid,
      &DetourNavigationMesh::get_uuid,
      "",
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_STORAGE,
      GODOT_PROPERTY_HINT_NONE);

  register_property<DetourNavigationMesh, PoolByteArray>(
      "serialized_navmesh_data",
      &DetourNavigationMesh::set_serialized_navmesh_data,
      &DetourNavigationMesh::get_serialized_navmesh_data,
      PoolByteArray(),
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_STORAGE,
      GODOT_PROPERTY_HINT_NONE);

  register_property<DetourNavigationMesh, Ref<NavmeshParameters>>(
      "parameters",
      &DetourNavigationMesh::navmesh_parameters,
      Ref<NavmeshParameters>(),
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_DEFAULT,
      GODOT_PROPERTY_HINT_RESOURCE_TYPE,
      "Resource");
  register_property<DetourNavigationMesh, Ref<ArrayMesh>>(
      "debug_mesh",
      &DetourNavigationMesh::debug_mesh,
      nullptr,
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_STORAGE,
      GODOT_PROPERTY_HINT_NONE);
...
void DetourNavigationMesh::build_navmesh()
{
  ...
  if (dtmi == NULL)
  {
    ERR_PRINT("DetourNavigation must be a direct parent of DetourNavigationMesh");
    return;
  }
  clear_navmesh();
...
Dictionary DetourNavigationMesh::find_path(Variant from, Variant to)
{
  ...
  // Dictionary result = nav_query->find_path(Vector3(0.f, 0.f, 0.f), Vector3(11.f, 0.3f, 11.f),
  // Vector3(50.0f, 3.f, 50.f), new DetourNavigationQueryFilter());
  Dictionary result =
...
{
  if (generator == nullptr || input_meshes_storage.size() == 0 ||
      input_meshes_storage.size() != input_transforms_storage.size())
  {
    return false;
  }
...
DetourNavigationMeshGenerator* DetourNavigationMesh::init_generator(Transform global_transform)
{
  ...
  dtnavmesh_gen->init_mesh_data(meshes, transforms, aabbs, global_transform, collision_ids);
...
void DetourNavigationMesh::set_debug_mesh_color(Color dmc)
{
  debug_mesh_color = dmc;
  if (debug_mesh_instance != nullptr && debug_mesh_instance->get_material_override() != nullptr)
  {
    ((Ref<SpatialMaterial>)(debug_mesh_instance->get_material_override()))
        ->set_albedo(debug_mesh_color);
  }
}
} // namespace godot
