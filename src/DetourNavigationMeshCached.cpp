...
void DetourNavigationMeshCached::_register_methods()
{
  ...
  register_property<DetourNavigationMeshCached, int>(
      "collision_mask",
      &DetourNavigationMeshCached::set_collision_mask,
      &DetourNavigationMeshCached::get_collision_mask,
      1,
  ...
  register_property<DetourNavigationMeshCached, int>(
      "dynamic_objects_collision_mask",
      &DetourNavigationMeshCached::set_dynamic_collision_mask,
      &DetourNavigationMeshCached::get_dynamic_collision_mask,
      1,
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_DEFAULT,
      GODOT_PROPERTY_HINT_LAYERS_3D_PHYSICS);

  register_property<DetourNavigationMeshCached, Array>(
      "input_meshes_storage",
      &DetourNavigationMeshCached::set_input_meshes_storage,
      &DetourNavigationMeshCached::get_input_meshes_storage,
      Array(),
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_STORAGE,
      GODOT_PROPERTY_HINT_NONE);
  register_property<DetourNavigationMeshCached, Array>(
      "input_transforms_storage",
      &DetourNavigationMeshCached::set_input_transforms_storage,
      &DetourNavigationMeshCached::get_input_transforms_storage,
      Array(),
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_STORAGE,
      GODOT_PROPERTY_HINT_NONE);
  register_property<DetourNavigationMeshCached, Array>(
      "input_aabbs_storage",
      &DetourNavigationMeshCached::set_input_aabbs_storage,
      &DetourNavigationMeshCached::get_input_aabbs_storage,
      Array(),
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_STORAGE,
      GODOT_PROPERTY_HINT_NONE);
  register_property<DetourNavigationMeshCached, Array>(
      "collision_ids_storage",
      &DetourNavigationMeshCached::set_collision_ids_storage,
      &DetourNavigationMeshCached::get_collision_ids_storage,
      Array(),
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_STORAGE,
      GODOT_PROPERTY_HINT_NONE);

  register_property<DetourNavigationMeshCached, PoolByteArray>(
      "serialized_navmesh_data",
      &DetourNavigationMeshCached::set_serialized_navmesh_data,
      &DetourNavigationMeshCached::get_serialized_navmesh_data,
      PoolByteArray(),
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_STORAGE,
      GODOT_PROPERTY_HINT_NONE);
  ...
  register_property<DetourNavigationMeshCached, Color>(
      "debug_mesh_color",
      &DetourNavigationMeshCached::set_debug_mesh_color,
      &DetourNavigationMeshCached::get_debug_mesh_color,
      Color(0.1f, 1.0f, 0.7f, 0.4f));

  register_property<DetourNavigationMeshCached, Ref<ArrayMesh>>(
      "debug_mesh",
      &DetourNavigationMeshCached::debug_mesh,
      nullptr,
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_STORAGE,
      GODOT_PROPERTY_HINT_NONE);
  register_property<DetourNavigationMeshCached, Ref<CachedNavmeshParameters>>(
      "parameters",
      &DetourNavigationMeshCached::set_navmesh_parameters,
      &DetourNavigationMeshCached::get_navmesh_parameters,
      Ref<CachedNavmeshParameters>(),
      GODOT_METHOD_RPC_MODE_DISABLED,
      GODOT_PROPERTY_USAGE_DEFAULT,
...
bool DetourNavigationMeshCached::load_mesh()
{
  ...
  bool success = Serializer::deserializeNavigationMeshCached(
      serialized_navmesh_data, tile_cache, detour_navmesh, mesh_process);
...
{
  serialized_navmesh_data =
      Serializer::serializeNavigationMeshCached(tile_cache, get_detour_navmesh());
  store_inputs();
}
    ...
    float rotationY)
{
  ...
  if (dtStatusFailed(tile_cache->addBoxObstacle(&pos.coord[0], &extents.coord[0], rotationY, &ref)))
  {
...
Dictionary DetourNavigationMeshCached::find_path(Variant from, Variant to)
{
  ...
  Dictionary result =
      nav_query->find_path((Vector3)from, (Vector3)to, Vector3(50.0f, 50.f, 50.f), query_filter);
  return result;
}

DetourNavigationMeshCacheGenerator* DetourNavigationMeshCached::init_generator(
    Transform global_transform)
{
  ...
  dtnavmesh_gen->init_mesh_data(meshes, transforms, aabbs, global_transform, cids);
...
void DetourNavigationMeshCached::recalculate_tiles()
{
  ...
  tile_box->set_extents(
      Vector3(tile_edge_length * 0.52f, bounding_box.get_size().y, tile_edge_length * 0.52f));
          ...
          if (physics_body)
          {
            for (int l = 0; l < physics_body->get_child_count(); ++l)
            {
              CollisionShape* collision_shape =
                  Object::cast_to<CollisionShape>(physics_body->get_child(l));
              if (collision_shape)
              {
...
void DetourNavigationMeshCached::refresh_obstacle(CollisionShape* collision_shape)
{
  ...
  else if (s->get_class() == "CylinderShape")
  {
    ...
    obst_id = add_cylinder_obstacle(
        ...
        cylinder->get_radius() *
            std::max(transform.get_basis().get_scale().x, transform.get_basis().get_scale().z),
