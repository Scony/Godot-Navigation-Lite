...
class DetourNavigationMeshCached : public DetourNavigationMesh
{
 ...
 public:
  ...
  int get_dynamic_collision_mask() { return dynamic_collision_mask; }
  ...
  Ref<CachedNavmeshParameters> get_navmesh_parameters() { return navmesh_parameters; }

  DetourNavigationMeshCacheGenerator* get_generator() { return generator; }
